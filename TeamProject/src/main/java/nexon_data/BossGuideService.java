...
public class BossGuideService {
    public static class BossStageData {
        ...
        public BossStageData() {
            ...
            this.powerThresholds = new long[] {
                3000000L, 10000000L, 20000000L, 20000000L,
        ...
        public long[] getPowerThresholds() {
            return powerThresholds;
        }

        public String[] getBossDescriptions() {
            return bossDescriptions;
        }
    }
